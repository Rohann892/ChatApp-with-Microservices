...
const ChatSideBar = ({
  ...
  return (
    <aside
      className={`fixed z-20 sm:static top-0 left-0 h-screen w-80 bg-gray-900 border-r border-gray-700 transform ${sidebarOpen ? "translate-x-0" : "-translate-x-full"} sm:translate-x-0 transition-transform duration-300 ease-in-out flex flex-col`}
    >
      {/* header */}
      <div className="p-6 border-b border-gray-700">
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            onClick={() => setShowAllUser(!showAllUsers)}
          >
            {showAllUsers ? (
              <X className="w-5 h-5" />
            ) : (
            ...
            {chats.map((chat) => {
              ...
              return (
                <button
                  ...
                  className={`w-full text-left p-4 rounded-lg border border-gray-700 hover:border-gray-600 hover:bg-gray-800 transition-colors ${isSelected ? "bg-blue-600 border-blue-500" : "border-gray-700 hover:border-gray-600 hover:bg-gray-800"}`}
                >
                  <div className="flex items-center gap-3">
                    <div className="relative">
